...
const SITE_DATA = {
  zh: {
    nav: { about: '關於逢甲', global: '台美合作方案', labs: '產學共建實驗室', highlight: '亮點成果', partners: '合作夥伴' },
    hero: {
      badge: '116 學年度成立',
      title: '半導體學院',
      ...
      programs: [
        {
          ...
          companies: '欣銓科技、矽品精密工業、台灣美光、旺宏電子、志聖工業'
        },
        {
          num: '02',
          title: '半導體製造及實習計畫',
    ...
    highlight: {
      ...
      desc: '台灣半導體產業協會（TSIA）首次頒發此獎，全國僅三所大專校院獲獎。王啟昌院長率領綠色動力實驗室團隊，以「結合熱力、固力模擬分析及 AI 技術，改善先進封裝設備加熱爐系統」獲此殊榮，為即將成立的半導體學院打下堅實產學基礎。',
    ...
    labs: {
      ...
      items: [
        ...
        },
        {
          ...
          title: '先進封裝無塵室',
          desc: '志聖工業是台灣頂尖的半導體先進封裝設備供應商，為台積電（TSMC）擴充 AI 晶片產能的關鍵夥伴。志聖專精於熱處理與壓膜技術，全力支援台積電 CoWoS 等先進封裝製程。憑藉卓越的設備可靠度與技術創新，志聖屢次榮獲台積電「優良供應商獎」。'
        }
      ]
    },
    partners: {
      ...
      featuredList: [
        ...
        },
        {
          ...
          desc: '台灣製程設備產業領導者志聖工業長期支持科技創新與教育發展，自 2022 年起無條件捐贈逢甲大學五年五百萬元，設立「志聖工業團隊創新激勵發展基金」，鼓勵師生共組團隊，推動跨領域創新計畫；2025 年更捐贈儀器設備與逢甲共建「前瞻能源與熱管理實驗室」。',
          linkLabel: '閱讀完整新聞報導',
